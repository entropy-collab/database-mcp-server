...
public class DataMaskingService {
    ...
    private static final List<MaskingRule> DEFAULT_RULES = List.of(
        new MaskingRule("EMAIL",
            ...
            (java.util.function.Function<String, String>) DataMaskingService::maskEmailStatic),

        new MaskingRule("PHONE",
            Pattern.compile("(?:\\+?1[-.]?)?(?:\\(\\d{3}\\)|\\d{3})[-.]?\\d{3}[-.]?\\d{4}"),
            (java.util.function.Function<String, String>) DataMaskingService::maskPhoneStatic),
